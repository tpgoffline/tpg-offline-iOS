...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-tpg offline/AKPickerView_Swift.framework"
  install_framework "Pods-tpg offline/Alamofire.framework"
  install_framework "Pods-tpg offline/Async.framework"
  ...
  install_framework "Pods-tpg offline/Localize_Swift.framework"
  install_framework "Pods-tpg offline/Log.framework"
  install_framework "Pods-tpg offline/MRProgress.framework"
  install_framework "Pods-tpg offline/NVActivityIndicatorView.framework"
  install_framework "Pods-tpg offline/Onboard.framework"
  install_framework "Pods-tpg offline/PermissionScope.framework"
  install_framework "Pods-tpg offline/SCLAlertView.framework"
  install_framework "Pods-tpg offline/SwiftDate.framework"
  install_framework "Pods-tpg offline/SwiftInAppPurchase.framework"
  install_framework "Pods-tpg offline/SwiftTweaks.framework"
