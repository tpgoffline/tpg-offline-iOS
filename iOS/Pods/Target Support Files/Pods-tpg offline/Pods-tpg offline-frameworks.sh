...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/NVActivityIndicatorView/NVActivityIndicatorView.framework"
  ...
  install_framework "$CONFIGURATION_BUILD_DIR/SwiftInAppPurchase/SwiftInAppPurchase.framework"
