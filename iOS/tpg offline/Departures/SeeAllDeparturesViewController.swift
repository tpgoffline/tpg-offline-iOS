...
extension SeeAllDeparturesViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "tousLesDepartsCell", for: indexPath) as! AllDeparturesCollectionViewCell // swiftlint:disable:this force_cast
