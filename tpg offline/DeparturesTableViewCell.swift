...
//      TODO: find a new icon for not accessible buses
//      notPMRImage.image = departure.reducedMobilityAccessibility == .accessible ?
//      nil : #imageLiteral(resourceName: "notPMR").maskWith(color: App.textColor)
//      notPMRImage.isHidden = departure.reducedMobilityAccessibility == .accessible
      ...
      case "&gt;1h":
        ...
        if let time = time {
          ...
          rightImage.image = #imageLiteral(resourceName: "warning").colorize(with: App.textColor)
      ...
      case "no more":
        rightTimeLabel.text = ""
        rightTimeLabel.isHidden = true
        rightImage.image = #imageLiteral(resourceName: "close").colorize(with: .gray)
        rightImage.isHidden = false
      ...
      case "0":
        rightTimeLabel.text = ""
        rightTimeLabel.isHidden = true
        rightImage.image = #imageLiteral(resourceName: "bus").colorize(with: App.textColor)
        rightImage.isHidden = false
        canBeSelected = true
...
//                                  inMinutes: departure.leftTime.accessibleTime)
      ...
      wifiImage.image = departure.wifi ? #imageLiteral(resourceName: "wifi").colorize(with: App.textColor) : nil
      ...
      if let platform = departure.platform {
        ...
        platformLabel.textColor = App.textColor
      ...
      self.selectedBackgroundView?.backgroundColor = App.textColor.withAlphaComponent(0.1)
    }
  }
