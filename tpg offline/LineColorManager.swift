...
struct LineColorManager {
  private static var tpgLinesColor: [LineColor] =
    [LineColor(line: "1", color: UIColor(hexString: "5a1e82")!),
     ...
     LineColor(line: "20", color: UIColor(hexString: "00A24D")!),
     ...
     LineColor(line: "64", color: UIColor(hexString: "#E0659A")!),
     LineColor(line: "66", color: UIColor(hexString: "#EAA8C1")!),
     LineColor(line: "68", color: UIColor(hexString: "#E0659A")!),
